...
(define (lepton-info)
	(list
	'lepton-info
	"Netlist generated by kicad back end for lepton-netlist."
	"Report issues to https://github.com/noqsi/gnet-kicad/issues"
	(list 'command (program-arguments))
	)
)
